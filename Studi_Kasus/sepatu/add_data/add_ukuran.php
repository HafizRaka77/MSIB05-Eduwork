        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-primary">
              <form action="../backend/proses_add_ukuran.php" method="post" enctype="multipart/form-data">
                <div class="card-body col-6">
                  <div class="form-group">
                    <label for="ukuranSepatu">Ukuran Sepatu</label>
                    <input type="number" class="form-control" id="ukuran" name="ukuran" placeholder="Masukkan Ukuran Sepatu" required>
                  </div>
                </div>
