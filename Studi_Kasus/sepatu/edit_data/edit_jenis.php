        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-primary">
              ...
              ?>
              <form action="../backend/proses_edit_jenis.php" method="post">
                <div class="card-body col-6">
                  <div class="form-group">
                    <label for="jenis_sepatu">Jenis Sepatu</label>
                    <input type="hidden" name="id" id="id" value="<?php echo $data['id'] ?>">
                    <input type="text" class="form-control" id="jenis_sepatu" name="jenis_sepatu" value="<?php echo $data['jenis_sepatu']; ?>" required>
                  </div>
                </div>
